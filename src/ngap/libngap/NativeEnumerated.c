...
asn_TYPE_operation_t asn_OP_NativeEnumerated = {
    ...
    0,
#else
    NativeEnumerated_decode_oer,  NativeEnumerated_encode_oer,
    ...
    0,
#else
    NativeEnumerated_decode_uper, NativeEnumerated_encode_uper,
    NativeEnumerated_decode_aper, NativeEnumerated_encode_aper,
...
asn_dec_rval_t NativeEnumerated_decode_aper(
  ...
  if (ct && ct->upper_bound >= 255) {
    ...
    ASN_DEBUG(
        "For NativeEnumerated %s,offset= %lu Padding bits = %d", td->name,
        pd->moved, padding);
    ASN_DEBUG(
        "For NativeEnumerated %s, upper bound = %lu", td->name,
        ct->upper_bound);
