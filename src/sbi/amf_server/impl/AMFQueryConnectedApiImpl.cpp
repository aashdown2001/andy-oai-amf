...
void AMFQueryConnectedApiImpl::gnbs_get_am_data(Pistache::Http::ResponseWriter &response) {
...
void AMFQueryConnectedApiImpl::ues_get_am_data(Pistache::Http::ResponseWriter &response) {
    response.headers().add<Pistache::Http::Header::AccessControlAllowOrigin>("*");
    nlohmann::json response_data_json = {};
    nlohmann::json json_array = nlohmann::json::array();
