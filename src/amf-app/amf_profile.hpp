...
class nf_profile : public std::enable_shared_from_this<nf_profile> {
 public:
   ...
   * @param [std::vector<_3gpp_23003::snssai_t> &] s: SNSSAIs
   * @return void
   */
  void set_nf_snssais(const std::vector<_3gpp_23003::snssai_t>& s);

  /*
   * Add SNSSAI
   * @param [_3gpp_23003::snssai_t &] s: SNSSAI
   * @return void
   */
  void add_snssai(const _3gpp_23003::snssai_t& s);

  /*
   * Get NF instance SNSSAIs
   * @param [std::vector<_3gpp_23003::snssai_t> &] s: store instance's SNSSAIs
   * @return void:
   */
  void get_nf_snssais(std::vector<_3gpp_23003::snssai_t>& s) const;
 ...
 protected:
  ...
  std::vector<_3gpp_23003::snssai_t> snssais;
...
class amf_profile : public nf_profile {
 public:
  ...
  /*
   * Add nf service
   * @param [_3gpp_23003::snssai_t &] n: nf service
   * @return void
   */
  ...
  /*
   * Get NF services
   * @param [std::vector<_3gpp_23003::snssai_t> &] n: store instance's nf services
   * @return void:
   */
