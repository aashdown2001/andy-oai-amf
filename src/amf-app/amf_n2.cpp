...
void amf_n2_task(void* args_p) {
  ...
  itti_inst->notify_task_ready(task_id);
    ...
    // std::string udsf_url = "http://192.168.199.201:7123/nudsf-dr/v1/amfdata/"+ std::string("gnb_context/records/") +  record_id;
    // while(1)
...
void amf_n2::handle_itti_message(itti_ng_setup_request& itti_msg) {
  ...
  // udsf_url = "http://192.168.199.201:7123/nudsf-dr/v1/amfdata/" + std::string("gnb_context/records/") + std::to_string(itti_msg.assoc_id) ;
...
void amf_n2::handle_itti_message(itti_initial_ue_message& init_ue_msg) {
  ...
  NrCgi_t cgi;
    if (!init_ue_msg.initUeMsg->get5GS_TMSI(_5g_s_tmsi)) {
        ...
        ServiceRequest *serReq = new ServiceRequest();
          ...
          else
          {
            ...
            if(amf_n1_inst->is_guti_2_nas_context_in_udsf(guti))
            {
                ...
                std::string udsf_url3 = "http://192.168.199.201:7123/nudsf-dr/v1/amfdata/"+ std::string("nas_context/records/") +  record_id_nas;
      ...
      if(amf_n1_inst->is_guti_2_nas_context_in_udsf(guti))
      {
          ...
          nlohmann::json udsf_response; 
          std::string record_id_nas = "guti=\'" + guti + "\'";
          std::string udsf_url = "http://192.168.199.201:7123/nudsf-dr/v1/amfdata/"+ std::string("nas_context/records/") +  record_id_nas;
          if(!amf_n2_inst->curl_http_client_udsf(udsf_url,"","GET",udsf_response))
          {
            Logger::amf_n1().error("No existing nas_context with GUTI %s",guti.c_str());
            return ;
      ...
      if (amf_n1_inst->check_security_header_type(type2, (uint8_t *)bdata(itti_msg->nas_buf))) 
      {
        ...
        ServiceRequest *serReq2 = new ServiceRequest();
          ...
          else
          {
            ...
            std::string udsf_url_nas = "http://192.168.199.201:7123/nudsf-dr/v1/amfdata/" + std::string("nas_context/records/") +record_id_nas ;
            udsf_response;
 ...
 // 
  ...
  std::string udsf_put_url = "http://192.168.199.201:7123/nudsf-dr/v1/amfdata/" + std::string("ue_ngap_context/records/") + record_id_ue_ngap ;
 ...
 // nlohmann::json udsf_response;
  ...
  // udsf_put_url = "http://192.168.199.201:7123/nudsf-dr/v1/amfdata/" + std::string("ue_ngap_context/records/") + std::to_string(unc.get()->ran_ue_ngap_id) ;
...
void amf_n2::handle_itti_message(itti_ul_nas_transport& ul_nas_transport) {
  ...
  std::string udsf_url_ue_ngap_context = "http://192.168.199.201:7123/nudsf-dr/v1/amfdata/" + std::string("ue_ngap_context/records/") + record_id ;
...
void amf_n2::handle_itti_message(itti_dl_nas_transport& dl_nas_transport) {
 ...
 std::string udsf_url = "http://192.168.199.201:7123/nudsf-dr/v1/amfdata/" + std::string("ue_ngap_context/records/") + record_id ;
  if(!amf_n2_inst->curl_http_client_udsf(udsf_url,"","GET",udsf_response)){
    Logger::amf_n2().error("No existing ue_ngap context with ran_ue_ngap_id ");
    return;
  }
 ...
 //printf("---------------std::to_string(unc.get()->gnb_assoc_id) ----------------%s",std::to_string(unc.get()->gnb_assoc_id) );
  ...
  udsf_url = "http://192.168.199.201:7123/nudsf-dr/v1/amfdata/" + std::string("gnb_context/records/") + record_id ;
  if(!amf_n2_inst->curl_http_client_udsf(udsf_url,"","GET",udsf_response)){
 ...
 /***************hsx add***************/
  ...
  std::string udsf_put_url = "http://192.168.199.201:7123/nudsf-dr/v1/amfdata/" + std::string("ue_ngap_context/records/") + record_id ;
  nlohmann::json udsf_ue_ngap_context;
  udsf_ue_ngap_context["meta"] ["tags"] = {
...
std::shared_ptr<pdu_session_context> psc = std::shared_ptr<pdu_session_context>(new pdu_session_context());
 ...
 // nlohmann::json udsf_response;
  ...
  udsf_url = "http://192.168.199.201:7123/nudsf-dr/v1/amfdata/" + std::string("pdu_session_context/records/") + record_id ;
  if(!amf_n2_inst->curl_http_client_udsf(udsf_url,"","GET",udsf_response)){
...
void amf_n2::handle_itti_message(
  ...
  std::string udsf_update_url = "http://192.168.199.201:7123/nudsf-dr/v1/amfdata/" + std::string("gnb_context/records/") + record_id ;
...
std::shared_ptr<pdu_session_context> psc = std::shared_ptr<pdu_session_context>(new pdu_session_context());
  ...
  std::string udsf_url = "http://192.168.199.201:7123/nudsf-dr/v1/amfdata/" + std::string("pdu_session_context/records/") + record_id;
  if(!amf_n2_inst->curl_http_client_udsf(udsf_url,"","GET",udsf_response)){
    Logger::amf_n2().error("No existing pdu_session_context with assoc_id ");
  }
  else{
